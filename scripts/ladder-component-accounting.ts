...
export function auditComponentAccounting(candles: Candle[], events: ResearchInventoryEvent[], metrics: ExposureMetrics,
  startIdx: number, endIdx: number, capital: number, fee: number,
  research?: { fraction: number; fillDelayMs: number }) {
