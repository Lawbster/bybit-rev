...
import {choose,predicates,validate,type Pulse} from './sr-partial-audit-policy';
...
validate(JSON.parse(fs.readFileSync('research-inputs/sr-partial-audit-srp01-2026-09-16.json','utf8')).definition);
